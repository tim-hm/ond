...
**Shipped since this list was drafted**: humming breath, and all four proposed occasions — `riding-out-a-craving`, `when-you-cant-get-a-satisfying-breath`, `in-a-tight-spot` and `feeling-queasy`. Their patterns, claims, citations, refusals and safety facts now live in §3.12 and §3.13. What remains undecided in Tier 2 is everything below.
